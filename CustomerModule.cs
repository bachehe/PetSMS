    ...
    public partial class CustomerModule : Form
    {
            ...
            try
            {
                ...
                if (check)
                {
                   ...
                   "Customer Registration", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                    {
                        cm = new SqlCommand("INSERT INTO tbCustomer(name, address, phone)" +
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (check)
                {
                    if (MessageBox.Show("Are you sure you want to edit this record?",
                   "Record Edit", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                    {
                        ...
                        cm.ExecuteNonQuery();
                        cn.Close();
                        MessageBox.Show("Custoemr data has been successfully updated!", title);
                        Clear();
                        customer.LoadCustomer();
                        this.Dispose(); //autoclosing
                    }
                }
            }
            catch (Exception ex)
